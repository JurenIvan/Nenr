...
public class Main {
    ...
    private static final double MUTATION_DEVIATION = 0.3;
...
//        var selector = new GenerationalBreederSelection<>(mutator, picker, breeder, true);
            var selector = new TournamentNSelection<>(breeder, evaluator, mutator, picker, 25, 8);
            var geneticAlgorithm = new GeneticAlgorithm<>(evaluator, populationInitializer, selector, 100000000, true);
